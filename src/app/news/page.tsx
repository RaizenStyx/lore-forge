...
export default async function ComingSoon() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col bg-gray-900 font-sans">
       <div className="flex-grow grid grid-cols-1 lg:grid-cols-3 gap-8 p-6 lg:p-8 bg-gray-950 text-gray-50">
        ...
        <section className="lg:col-span-2 space-y-10 p-8 bg-gray-900 rounded-xl shadow-xl ring-1 ring-cyan-400/20 border border-gray-700 flex flex-col justify-start">
          ...
          <div className="text-lg text-gray-50 leading-relaxed space-y-4">
            <p>
              Say goodbye to writer&apos;s block and endless brainstorming. With Lore Forge, you can swiftly generate compelling narratives for your characters, intricate histories for your factions, expansive backstories for your worlds, and detailed outlines for your quests. Simply provide a high-level prompt, select your desired genre and lore type, and watch as our advanced AI brings your concepts to life.
            </p>
          ...
          <h3 className="text-3xl font-bold text-gray-50 mb-6 border-b border-gray-700 pb-4 flex items-center gap-3">
            ...
            The Future Ideas of Storytelling:
          </h3>
      ...
      <div className="flex-grow grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 lg:p-8 bg-gray-950 text-gray-50">
